...
<head>
	<title>Biologi</title>
	<link rel="stylesheet" type="text/css" href="../../css/lomba.css">
</head>
<body>
	<div class="row">
		<div class="koloimg">
			<img src="../../img/biologi.jpg" style="height: 100%">
		</div>
		<div class="kolomtxt" style="background: dimgrey">
			<h2 class="judul">Juara 1 OSN Bedah Makhluk Hidup
				<h5 class="judul">7 Oktober 2018</h3>
			</h2><hr>
			<p class="text">
				Tidak pernah terbesit dalam benak siswi SMA Kharisma Bangsa, Maria Patricia Inggriani bisa membawa medali emas dari International Biology Olympiad (IBO) di Aarhus, Denmark. Berkompetisi dengan 241 siswa dari 61 negara diakuinya bukanlah hal mudah seperti membalikkan telapak tangan.
